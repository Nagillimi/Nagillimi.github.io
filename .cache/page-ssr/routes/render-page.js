...
var _isLocalLink = __webpack_require__(587);
...
var _applyTrailingSlashOption = __webpack_require__(641);

var _parsePath2 = __webpack_require__(752);
...
var React = _interopRequireWildcard(__webpack_require__(115));
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 638)),"component---src-pages-index-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-tsx */ 691).then(__webpack_require__.bind(__webpack_require__, 944))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-mdx',plugin:__webpack_require__(406),options:{"plugins":[],"extensions":[".mdx"],"defaultLayouts":{},"gatsbyRemarkPlugins":[],"lessBabel":false,"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"C:\\Users\\bmill\\Documents\\PROJECTS\\WEBSITE\\site\\Nagillimi.github.io","commonmark":false}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(115);
...
var external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_ = __webpack_require__(115);
...
var public_page_renderer = __webpack_require__(743);
...
var find_path = __webpack_require__(755);
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement((external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
var MDXContext = /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createContext({});
var withMDXComponents = function withMDXComponents(Component) {
  return function (props) {
    var allComponents = useMDXComponents(props.components);
    return /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(Component, _extends({}, props, {
      components: allComponents
    }));
  };
};
var useMDXComponents = function useMDXComponents(components) {
  var contextComponents = external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().useContext(MDXContext);
...
var MDXProvider = function MDXProvider(props) {
  var allComponents = useMDXComponents(props.components);
  return /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(MDXContext.Provider, {
    value: allComponents
  }, props.children);
};
...
var DEFAULTS = {
  ...
  wrapper: function wrapper(_ref) {
    ...
    return /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement((external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).Fragment, {}, children);
  }
};
var MDXCreateElement = /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().forwardRef(function (props, ref) {
  ...
  if (propComponents) {
    return /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(Component, _objectSpread2(_objectSpread2({
      ref: ref
    }, etc), {}, {
  ...
  return /*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(Component, _objectSpread2({
    ref: ref
  }, etc));
});
...
;// CONCATENATED MODULE: ./node_modules/gatsby-plugin-mdx/context.js
const GatsbyMDXScopeContext=/*#__PURE__*/(0,external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_.createContext)({});const useMDXScope=scope=>{const contextScope=useContext(GatsbyMDXScopeContext);return scope||contextScope;};const MDXScopeProvider=({__mdxScope,children})=>/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(GatsbyMDXScopeContext.Provider,{value:__mdxScope},children);
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-mdx/loaders/mdx-components.js
var mdx_components = __webpack_require__(818);
...
function wrap_root_element_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?wrap_root_element_ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):wrap_root_element_ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}/**
 ...
 * Submit a PR
 */const componentsAndGuards={};const componentFromGuards=arr=>function GatsbyMDXComponentFinder(props){const{Component}=arr.find(({guard})=>guard?guard(props):true);return/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(Component,props);};mdx_components.plugins.forEach(({guards={},components})=>{Object.entries(components).forEach(([componentName,Component])=>{if(componentsAndGuards[componentName]){componentsAndGuards.push({guard:guards[componentName],Component});}else{componentsAndGuards[componentName]=[{guard:guards[componentName],Component}];}});});const components=Object.entries(componentsAndGuards).map(([name,arr])=>{return{[name]:componentFromGuards(arr.concat({guard:undefined,Component:name}))};}).reduce((acc,obj)=>{return _objectSpread(_objectSpread({},acc),obj);},{});// merge any components in wrapRootElement above this wrapRoot
const MDXConsumer=withMDXComponents(({components:componentsFromContext,children})=>/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(MDXScopeProvider,{__mdxScope:mdx_scopes},/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(MDXProvider,{components:_objectSpread(_objectSpread({},componentsFromContext),components)},children)));const WrapRootElement=({element})=>/*#__PURE__*/external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(MDXConsumer,null,element);/* harmony default export */ const wrap_root_element = (WrapRootElement);
...
var react_lifecycles_compat = __webpack_require__(712);
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  var children = _ref.children;
  return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
    ...
    function (baseContext) {
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_bmill_Documents_PROJECTS_WEBSITE_site_Nagillimi_github_io_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
"use strict";
module.exports = require("C:\\Users\\bmill\\Documents\\PROJECTS\\WEBSITE\\site\\Nagillimi.github.io\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\bmill\\Documents\\PROJECTS\\WEBSITE\\site\\Nagillimi.github.io\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-db109019bff945921aa3.js"],"app":["/app-3880b7a0353599383e84.js"],"component---src-pages-404-tsx":["/component---src-pages-404-tsx-dc97d10cbb246e1171d5.js"],"component---src-pages-index-tsx":["/component---src-pages-index-tsx-fc89c9011a22129a14d7.js"]}');
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(942);
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}const React=__webpack_require__(115);const path=__webpack_require__(423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(286);const{ServerLocation,Router,isRedirect}=__webpack_require__(631);const merge=__webpack_require__(996);const{StaticQueryContext}=__webpack_require__(533);const fs=__webpack_require__(505);const{WritableAsPromise}=__webpack_require__(897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(67);const asyncRequires=__webpack_require__(418);const{version:gatsbyVersion}=__webpack_require__(741);const{grabMatchParams}=__webpack_require__(755);const chunkMapping=__webpack_require__(804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../src/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(79);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${""}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${""}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${""}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
